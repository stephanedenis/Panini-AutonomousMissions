# Instructions Copilot - Panini-AutonomousMissions

📍 **CONTEXTE LOCAL :** Tu te trouves actuellement dans le sous-module `modules/missions/autonomous`.
**Mission stricte :** Workflows d'IA asynchrones.
